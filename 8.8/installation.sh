...
if [ ! -f "charge_electrique-v8.8.py" ]; then
...
cp charge_electrique-v8.8.py "$INSTALL_DIR/"
chmod +x "$INSTALL_DIR/charge_electrique-v8.8.py"
...
Exec=python3 $INSTALL_DIR/charge_electrique-v8.8.py
