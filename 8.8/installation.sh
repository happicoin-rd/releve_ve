...
echo "==============================================="
echo " Installation de Suivi de Charge VE (v8.8)"
echo "==============================================="

# Vérification du fichier Python
SCRIPT_SOURCE="charge_electrique-v8.8.py"
...
cp "$SCRIPT_SOURCE" "$APP_DIR/bin/charge_electrique-v8.8.py"
chmod +x "$APP_DIR/bin/charge_electrique-v8.8.py"
...
Exec=$APP_DIR/venv/bin/python $APP_DIR/bin/charge_electrique-v8.8.py
